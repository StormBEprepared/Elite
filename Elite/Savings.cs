...
namespace Elite
{
    ...
    public partial class Savings : Form
    {
        ...
        private void Savings_Load(object sender, EventArgs e)
        {
            ...
            label4.Text = UserName;//ASA S-A TRANSFERAT USERNAME-UL DIN FORM1.
            
            string query = "SELECT Amount,Time FROM DataForEveryUser WHERE Account='"+label4.Text+"' AND TypeOfTransaction='+'";
            SqlDataAdapter adapter = new SqlDataAdapter(query, conn);
            DataTable dt = new DataTable();
            adapter.Fill(dt);
            
            dataGridView1.DataSource = dt;
            //This is the datatable showing the past saving activities on the specific account.
